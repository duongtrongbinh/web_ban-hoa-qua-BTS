    ...
    <div class="row">
        <div class="col-12">
            <div class="form-group">
                ...
                <input type="text" name="name" class="form-control mt-2" placeholder="Vui lòng nhập tên vai trò.">
                {{-- <small id="helpId" class="text-muted">Help text</small> --}}
              </div>
              <div class="form-group mt-3">
                  <label>Mô tả vai trò</label>
                  <input type="text" name="display_name" class="form-control mt-2" placeholder="Vui lòng nhập mô tả vai trò của bạn.">
                  {{-- <small id="helpId" class="text-muted">Help text</small> --}}
              </div>
        </div>
        <div class="col-12 mt-5">
            ...
            <div class="card">
                ...
                <div class="card-body d-flex justify-content-between mt-3">
                    ...
                    <div class="div">
                        <div class="form-check">
                            <input class="form-check-input check_ii" type="checkbox" value="{{ $value->id}}" name="permisson[]">
