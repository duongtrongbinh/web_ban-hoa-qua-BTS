    ...
    <form method="POST" action="{{ route('update_blog',[$blog->id])}}" enctype="multipart/form-data">  
      ...
      @method('PUT')
        ...
        <div class="form-group mt-3">
            ...
            <input type="text" name="title" class="form-control" placeholder="Nhập title ..." value="{{ $blog->title}}">
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group mt-3 col-6">
                <img src="{{ $blog->code_image}}" alt="{{ $blog->name_image}}" width="300px" height="200px">
            </div>
        </div>

        <div class="form-group col mt-2">
            <label for="" class="form-lable mb-2">Content</label>
            <textarea class="form-control my-editor-tinymce4" name="content" placeholder="Nhập content ...">{!!$blog->content!!}</textarea>
        </div>
