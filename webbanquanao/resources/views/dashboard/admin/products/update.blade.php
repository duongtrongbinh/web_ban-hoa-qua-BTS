        ...
        <div class="modal-body">
          ...
          <div class="row">
              <div class="form-group col-3 mt-3">
                ...
                <input type="text" name="height" class="form-control" placeholder="Nhập heights ..."  value="{{ $product->height }}">
            ...
            <div class="form-group col-3 mt-3">
                ...
                <input type="text" name="length" class="form-control" placeholder="Nhập length ..." value="{{ $product->length }}">
            ...
            <div class="form-group col-3 mt-3">
              ...
              <input type="text" name="width" class="form-control" placeholder="Nhập width ..." value="{{ $product->width }}">
              @if($errors->has('width'))
