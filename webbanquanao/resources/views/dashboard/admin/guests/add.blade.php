...
<form action="{{ route('add_user')}}" method="post" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <input type="hidden" name="role[]" class="form-control mt-2" value="3">
            <input type="hidden" name="ag" class="form-control mt-2" value="g">
          </div>
        <div class="col-12 text-center mt-3">
            <button type="submit" class="btn btn-primary">Add Khách hàng</button>
        </div>
    </div>
